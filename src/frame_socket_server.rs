            ...
            loop {
                ...
                if medium_power_mode {
                    ...
                    }) = message.as_ref()
                    {
                        ...
                        // info!("Is recording {}, frame bytes {}",is_recording,*frame_bytes);
